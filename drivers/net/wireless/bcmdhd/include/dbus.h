...
#ifdef CONFIG_WLAN_AARCH64_SUPPORT
#define DBUSERR(args) do {if (USE_NET_RATELIMIT) printf args;} while (0)
#else
#define DBUSERR(args)
#endif
...
typedef struct dbus_callbacks {
	...
	void (*pktfree)(void *cbarg, void *p, bool send);
        ...
        void (*netdev_running)(void *cbarg, int idx);
        void (*netdev_wl)(void *cbarg, int idx, int cmd);
        void (*set_wow)(void *cbarg, int idx, int val);
#endif
} dbus_callbacks_t;
...
typedef struct dbus_intf_callbacks {
	...
	void (*rxerr_indicate)(void *cbarg, bool on);
        ...
        void (*netdev_running)(void *cbarg, int idx);
        void (*netdev_wl)(void *cbarg, int idx, int cmd);
        void (*set_wow)(void *cbarg, int idx, int cmd);
#endif
...
#ifdef CONFIG_WLAN_STR_SUPPORT
extern void dhd_dbus_set_suspend_state(void *handle, uint32 val);
extern void dhd_dbus_set_wow(void *handle, int idx, int val);
#endif
