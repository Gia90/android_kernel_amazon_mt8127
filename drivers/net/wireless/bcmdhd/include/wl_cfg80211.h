 ...
 *
 * $Id: wl_cfg80211.h 588508 2015-09-24 09:53:35Z $
 */
...
extern s32 wl_cfg80211_wbtext_config(struct net_device *ndev, char *data,
		char *command, int total_len);
extern int wl_android_wbtext_weight_config(struct net_device *ndev, char *data,
		char *command, int total_len);
extern int wl_android_wbtext_table_config(struct net_device *ndev, char *data,
		char *command, int total_len);
